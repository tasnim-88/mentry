            ...
            <main className="grow flex items-center justify-center py-12 sm:py-20">
                <div className="flex flex-col px-4 py-6 w-full max-w-lg">
                    <div className="flex flex-col items-center gap-6 text-center">
                        <div className="flex items-center justify-center w-50 h-50  rounded-full bg-red-500/10 text-red-500">
                        ...
                        <Link to={'/pricing'} className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full mt-4">
